...
const guessesEl = document.querySelector('#guesses'); // The guesses container
...
function displayGuessFeedback(guess) {
    ...
    for (let i = 0; i < guess.length; i++) {
        ...
        letterSpan.innerText = letter; // Set the text content of the span
...
inputEl.addEventListener('keydown', (event) => {
    if (event.key === 'Enter') {
        ...
        if (guess === correctAnswer.toUpperCase()) {
            ...
            inputEl.setAttribute('disabled', true); // Disable input on win
